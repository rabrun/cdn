		...
		<div class="site-info" theme-info="Sakurairo v<?php echo SAKURA_VERSION; ?>">
			...
			<p style="font-family: 'Ubuntu', sans-serif;">
					<span style="color: #b9b9b9;">
						...
						<!--<script type="text/javascript" src="https://xingw.top/diy/yan/api.php?charset=utf-8&encode=js" ></script> -->
						<!--一言 <script type="text/javascript" src="https://api.btstu.cn/yan/api.php?charset=utf-8&encode=js" ></script>-->
                        <script type="text/javascript" src="https://xingw.top/diy/yan/api.php?charset=utf-8&encode=js" ></script>
						<div id="yan"><script>text()</script></div>
                        <?php endif; ?>
					    <p>© 2020 樱花飘落的时光 <a href="https://www.beian.miit.gov.cn/"  style="color:#000000">豫ICP备20005305号</a> </p>
					      <p style=color:orange">THEME BY <a href="https://asuhe.jp/" style="color:#000000">Hitomi</a>
					    THE SOURCE OF INITIAL THEME BY <a href="https://2heng.xin/" style="color:#000000">mashirozx</a> <a href="#" style="color:#000000">MORE SOURCE</a></p>
					    	</span>
				</p>
			</div>
		</div><!-- .site-info -->
...
<?php if (akina_option('sakura_widget')) : ?>
	...
	<div class="show-hide-wrap"><button class="show-hide"><svg xmlns="https://www.w3.org/2000/svg" version="1.1" viewBox="0 0 32 32"><path d="M22 16l-10.105-10.6-1.895 1.987 8.211 8.613-8.211 8.612 1.895 1.988 8.211-8.613z"></path></svg></button></div>
    </aside>
<?php endif; ?>
