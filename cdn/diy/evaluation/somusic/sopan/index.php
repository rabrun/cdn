...
<head>
    <meta charset="UTF-8">
    <title>网易云热评音乐-小歪博客 blog.ixiaowai.cn</title>
    ...
    <meta name="keywords" content="网易云热评音乐-小歪博客 blog.ixiaowai.cn">
    <meta name="description" content="网易云热评音乐-小歪博客 blog.ixiaowai.cn">
    ...
    <link rel="stylesheet" href="static/css/amazeui.min.css?v<?php echo MC_VERSION; ?>">
        ...
        <div class="am-popup" id="copr-info">
            <div class="am-popup-inner">
                ...
                <div class="am-popup-bd">
                    ...
                    <hr>
                    <h2>blog.ixiaowai.cn</h2>
                </div>
            </div>
        </div>
    </section>
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="#" target="_blank" rel="author">本源码来自：小歪博客</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
